...
void MediaProcessingJob::Execute() {
    ...
    try {
        if (options_.isCompression) {
            mediaEngine_.Compress(options_.inputPath, outputPath, options_.engineOptions, onProgress,
                                  isCancelled);
        } else {
            mediaEngine_.Convert(options_.inputPath, outputPath, options_.engineOptions, onProgress,
                                 isCancelled);
        }
